...
import com.springmvc.models.CollegeStudent;
import com.springmvc.models.MathGrade;
import com.springmvc.repository.HistoryGradesDao;
import com.springmvc.repository.MathGradesDao;
import com.springmvc.repository.ScienceGradesDao;
import com.springmvc.repository.StudentDao;
import com.springmvc.service.StudentAndGradeService;
...
public class GradebookControllerTest {
    ...
    public static void setup(){
        ...
        request.setParameter("firstname","Akshat");
        request.setParameter("lastname","Jogani");
        request.setParameter("email","akshat@gmail.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        ...
        student.setLastname("Jogani");
        student.setEmailAddress("akshat@gmail.com");
    ...
    public void createStudentHttpRequest() throws Exception{
        ...
        CollegeStudent verifyStudent=studentDao.findByEmailAddress("akshat@gmail.com");
    ...
    public void studentInformationHttpRequest() throws Exception{
        ...
        mockMvc.perform(get("/studentInformation/{id}",1))
                ...
                .andExpect(jsonPath("$.emailAddress",is("eric.roby@mail_school.com")));
    }
    ...
    @Test
    public void deleteAValidGradeHttpResponse() throws Exception{
    ...
    public void deleteANonValidGradeHttpRequest() throws Exception{
        ...
        mockMvc.perform(delete("/grades/{id}/{gradeType}",1,"hindi"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade was not found")));
