...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        studentService.createStudent("Chad", "Darby", "chad.darby@mail_school.com");

        CollegeStudent student = studentDao.findByEmailAddress("chad.darby@mail_school.com");

        assertEquals("chad.darby@mail_school.com", student.getEmailAddress(), "find by email");
    }
    ...
    public void studentInformationService() {
        ...
        assertEquals("eric.roby@mail_school.com", gradebookCollegeStudentTest.getEmailAddress());
